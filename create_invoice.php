      ...
      <div class="container1">
        ...
        <table>
          <tr><th colspan="3"><h3 align="center"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Order Details</h3></th>
            <th colspan="2"><input class="ibut" type="button" id="bt2" value="Back" onclick="location.href='products.php'" />
          <tr>
            <th>Order ID</th>
            <th><input type="text" name="order_id" id="a1" value=<?php echo $n+1 ?>></th>
          </tr>
          <tr>
          ...
          ?>            
                 ...
                 <button type="submit" name="submit" value="Submit" onclick=location.href='prizelist.php'>Submit</button>         
                  </form>
      </div>
    </div>
  </div>
